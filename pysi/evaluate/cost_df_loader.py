...
# メイン：DB -> cost_df
# =========================
def build_cost_df_from_sql(db_path: str, scenario_id: str | None = None) -> pd.DataFrame:
#def build_cost_df_from_sql(db_path: str) -> pd.DataFrame:
    ...
    "cost_df", out_cost_df,
    db_path=db_path, scenario_id=scenario_id, source="build_cost_df_from_sql")
