# .\pysi\scripts\upsert_inbound_cost_table2sql.py
# starter
# # 仮にプロジェクト直下に置いた場合
#python .\pysi\scripts\upsert_inbound_cost_table2sql.py `
#  --csv ".\data\sku_cost_table_inbound.csv" `
#  --db  ".\var\psi.sqlite"
# python .\pysi\scripts\upsert_inbound_cost_table2sql.py --csv ".\data\sku_cost_table_inbound.csv"  --db  ".\var\psi.sqlite"
import sqlite3
import pandas as pd
