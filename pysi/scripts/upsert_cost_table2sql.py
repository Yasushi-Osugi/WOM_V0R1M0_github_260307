...
CS_COLS = [
    ...
    "cs_prod_indirect_labor", "cs_prod_indirect_others",
    "cs_direct_labor_costs", "cs_depreciation_others", "cs_mfg_overhead"
]
def upsert_cost_csv_to_sql(csv_path: str, db_path: str):
    ...
    # 新しいsum_rの定義でバリデーション（>1.0 で Warning）
    ...
    for _, r in df.iterrows():
        rows.append((
            r["node_name"], r["product_name"],
            *[float(r[c]) for c in CS_COLS]
        ))
