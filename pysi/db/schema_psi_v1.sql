...
CREATE TABLE IF NOT EXISTS node_product (
  ...
  -- 生産系詳細コスト
  cs_prod_indirect_labor     REAL NOT NULL DEFAULT 0.0,
  cs_prod_indirect_others    REAL NOT NULL DEFAULT 0.0,
  cs_direct_labor_costs      REAL NOT NULL DEFAULT 0.0,
  cs_depreciation_others     REAL NOT NULL DEFAULT 0.0,
  cs_mfg_overhead            REAL NOT NULL DEFAULT 0.0,
