# SCN_optimiser_WOM_REALDATA_FINAL_FIXED.py
# あなたの会社のPSI Planner実データ完全準拠版（2025.11.20 最終確定）
...
for n in N:
    for t in T:
        ...
        model += outflow <= existing_cap[n] + added_cap + seasonal_limit - existing_cap[n]   # 季節上限はベース能力に上乗せ
