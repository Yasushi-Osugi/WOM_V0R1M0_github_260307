# SCN_optimiser_WOM_REALDATA_EXCEL_MENU.py
# 拡張メニューをExcelから読み込む完全版（2025.11.20）
...
# ====================== 9. モデル構築 =======================
model = LpProblem("WOM_REALDATA_EXCEL", LpMaximize)
T = list(range(1, 53))
...
# ====================== 実行 =======================
print("Excel拡張メニュー読み込み完了。最適化実行中...")
...
for arc in flow_menu:
    ...
    print(f"edge_flow['{arc}'] = {existing_flow[arc] + added}")
